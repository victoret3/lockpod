...
export declare class PromiseUsersApi {
    ...
    archiveWithHttpInfo(userId: string, idProperty?: string, _options?: Configuration): Promise<HttpInfo<void>>;
    ...
    getByIdWithHttpInfo(userId: string, idProperty?: string, _options?: Configuration): Promise<HttpInfo<PublicUser>>;
    ...
    replaceWithHttpInfo(userId: string, publicUserUpdate: PublicUserUpdate, idProperty?: string, _options?: Configuration): Promise<HttpInfo<PublicUser>>;
