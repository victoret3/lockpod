...
export declare class ObservableUsersApi {
    ...
    archiveWithHttpInfo(userId: string, idProperty?: string, _options?: Configuration): Observable<HttpInfo<void>>;
    ...
    getByIdWithHttpInfo(userId: string, idProperty?: string, _options?: Configuration): Observable<HttpInfo<PublicUser>>;
    ...
    replaceWithHttpInfo(userId: string, publicUserUpdate: PublicUserUpdate, idProperty?: string, _options?: Configuration): Observable<HttpInfo<PublicUser>>;
