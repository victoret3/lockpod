...
export declare class ObservableBasicApi {
    ...
    archiveWithHttpInfo(goalTargetId: string, _options?: Configuration): Observable<HttpInfo<void>>;
    archive(goalTargetId: string, _options?: Configuration): Observable<void>;
    ...
    updateWithHttpInfo(goalTargetId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObject>>;
    update(goalTargetId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<SimplePublicObject>;
}
