...
export declare class PromiseBasicApi {
    ...
    archiveWithHttpInfo(goalTargetId: string, _options?: Configuration): Promise<HttpInfo<void>>;
    ...
    updateWithHttpInfo(goalTargetId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<HttpInfo<SimplePublicObject>>;
