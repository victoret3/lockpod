...
class ObservableBasicApi {
    ...
    archiveWithHttpInfo(feedbackSubmissionId, _options) {
    ...
    archive(feedbackSubmissionId, _options) {
        return this.archiveWithHttpInfo(feedbackSubmissionId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    updateWithHttpInfo(feedbackSubmissionId, simplePublicObjectInput, idProperty, _options) {
    ...
    update(feedbackSubmissionId, simplePublicObjectInput, idProperty, _options) {
        return this.updateWithHttpInfo(feedbackSubmissionId, simplePublicObjectInput, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
