...
export declare class PromiseBasicApi {
    ...
    archiveWithHttpInfo(feedbackSubmissionId: string, _options?: Configuration): Promise<HttpInfo<void>>;
    ...
    updateWithHttpInfo(feedbackSubmissionId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<HttpInfo<SimplePublicObject>>;
