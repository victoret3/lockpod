...
export declare class ObservableBasicApi {
    ...
    archiveWithHttpInfo(feedbackSubmissionId: string, _options?: Configuration): Observable<HttpInfo<void>>;
    ...
    updateWithHttpInfo(feedbackSubmissionId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObject>>;
