...
export declare class PromiseGDPRApi {
    ...
    purgeWithHttpInfo(objectType: string, publicGdprDeleteInput: PublicGdprDeleteInput, _options?: Configuration): Promise<HttpInfo<void>>;
...
export declare class PromisePublicObjectApi {
    ...
    mergeWithHttpInfo(objectType: string, publicMergeInput: PublicMergeInput, _options?: Configuration): Promise<HttpInfo<SimplePublicObject>>;
