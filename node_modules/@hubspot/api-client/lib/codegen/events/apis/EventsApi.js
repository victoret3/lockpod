    ...
    getPage(objectType, eventType, occurredAfter, occurredBefore, objectId, indexTableName, indexSpecificMetadata, after, before, limit, sort, objectPropertyPropname, propertyPropname, id, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (indexTableName !== undefined) {
                requestContext.setQueryParam("indexTableName", ObjectSerializer_1.ObjectSerializer.serialize(indexTableName, "string", ""));
            }
            if (indexSpecificMetadata !== undefined) {
                requestContext.setQueryParam("indexSpecificMetadata", ObjectSerializer_1.ObjectSerializer.serialize(indexSpecificMetadata, "string", ""));
            }
            if (after !== undefined) {
