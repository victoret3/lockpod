...
class ObservableExtractApi {
    ...
    extractByPathWithHttpInfo(path, _options) {
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)((rsp) => this.responseProcessor.extractByPathWithHttpInfo(rsp)));
        }));
    }
    extractByPath(path, _options) {
        return this.extractByPathWithHttpInfo(path, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
