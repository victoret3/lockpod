...
export declare class TablesApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getDraftTableDetailsById(tableIdOrName: string, includeForeignIds?: boolean, archived?: boolean, _options?: Configuration): Promise<RequestContext>;
    getTableDetails(tableIdOrName: string, includeForeignIds?: boolean, archived?: boolean, _options?: Configuration): Promise<RequestContext>;
    ...
    updateDraftTable(tableIdOrName: string, hubDbTableV3Request: HubDbTableV3Request, includeForeignIds?: boolean, archived?: boolean, _options?: Configuration): Promise<RequestContext>;
}
