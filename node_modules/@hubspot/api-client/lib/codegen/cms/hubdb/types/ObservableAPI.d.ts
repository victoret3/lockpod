...
export declare class ObservableRowsApi {
    ...
    cloneDraftTableRowWithHttpInfo(tableIdOrName: string, rowId: string, _options?: Configuration): Observable<HttpInfo<HubDbTableRowV3>>;
    ...
    getDraftTableRowByIdWithHttpInfo(tableIdOrName: string, rowId: string, _options?: Configuration): Observable<HttpInfo<HubDbTableRowV3>>;
    getDraftTableRowById(tableIdOrName: string, rowId: string, _options?: Configuration): Observable<HubDbTableRowV3>;
    getTableRowWithHttpInfo(tableIdOrName: string, rowId: string, _options?: Configuration): Observable<HttpInfo<HubDbTableRowV3>>;
    getTableRow(tableIdOrName: string, rowId: string, _options?: Configuration): Observable<HubDbTableRowV3>;
    getTableRowsWithHttpInfo(tableIdOrName: string, sort?: Array<string>, after?: string, limit?: number, properties?: Array<string>, _options?: Configuration): Observable<HttpInfo<CollectionResponseWithTotalHubDbTableRowV3ForwardPaging>>;
    ...
    readDraftTableRowsWithHttpInfo(tableIdOrName: string, sort?: Array<string>, after?: string, limit?: number, properties?: Array<string>, _options?: Configuration): Observable<HttpInfo<CollectionResponseWithTotalHubDbTableRowV3ForwardPaging>>;
...
export declare class ObservableRowsBatchApi {
    ...
    cloneDraftTableRowsWithHttpInfo(tableIdOrName: string, batchInputString: BatchInputString, _options?: Configuration): Observable<HttpInfo<BatchResponseHubDbTableRowV3>>;
    cloneDraftTableRows(tableIdOrName: string, batchInputString: BatchInputString, _options?: Configuration): Observable<BatchResponseHubDbTableRowV3>;
...
export declare class ObservableTablesApi {
    ...
    getAllDraftTablesWithHttpInfo(sort?: Array<string>, after?: string, limit?: number, createdAt?: Date, createdAfter?: Date, createdBefore?: Date, updatedAt?: Date, updatedAfter?: Date, updatedBefore?: Date, archived?: boolean, _options?: Configuration): Observable<HttpInfo<CollectionResponseWithTotalHubDbTableV3ForwardPaging>>;
    ...
    getAllTablesWithHttpInfo(sort?: Array<string>, after?: string, limit?: number, createdAt?: Date, createdAfter?: Date, createdBefore?: Date, updatedAt?: Date, updatedAfter?: Date, updatedBefore?: Date, archived?: boolean, _options?: Configuration): Observable<HttpInfo<CollectionResponseWithTotalHubDbTableV3ForwardPaging>>;
    ...
    getDraftTableDetailsByIdWithHttpInfo(tableIdOrName: string, includeForeignIds?: boolean, archived?: boolean, _options?: Configuration): Observable<HttpInfo<HubDbTableV3>>;
    getDraftTableDetailsById(tableIdOrName: string, includeForeignIds?: boolean, archived?: boolean, _options?: Configuration): Observable<HubDbTableV3>;
    getTableDetailsWithHttpInfo(tableIdOrName: string, includeForeignIds?: boolean, archived?: boolean, _options?: Configuration): Observable<HttpInfo<HubDbTableV3>>;
    getTableDetails(tableIdOrName: string, includeForeignIds?: boolean, archived?: boolean, _options?: Configuration): Observable<HubDbTableV3>;
    ...
    updateDraftTableWithHttpInfo(tableIdOrName: string, hubDbTableV3Request: HubDbTableV3Request, includeForeignIds?: boolean, archived?: boolean, _options?: Configuration): Observable<HttpInfo<HubDbTableV3>>;
    updateDraftTable(tableIdOrName: string, hubDbTableV3Request: HubDbTableV3Request, includeForeignIds?: boolean, archived?: boolean, _options?: Configuration): Observable<HubDbTableV3>;
}
